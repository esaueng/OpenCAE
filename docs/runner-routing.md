...
Core and web build, unit tests, typechecks, configuration and bundle checks run on the fleet. The two Chrome verification commands stay hosted after quality succeeds.
