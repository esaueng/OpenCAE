...
export const starterMaterials: Material[] = [
  ...
  { id: "mat-acrylic", name: "Acrylic PMMA", category: "plastic", youngsModulus: 3200000000, poissonRatio: 0.35, density: 1180, yieldStrength: 65000000, thermalConductivity: 0.19 },
...
const manufacturingProfilesByMaterialId: Record<string, MaterialManufacturingProfile[]> = {
  ...
  "mat-acrylic": [bulkProfile("cnc_machining")],
