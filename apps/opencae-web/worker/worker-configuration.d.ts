/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/opencae-web/worker/worker-configuration.d.ts --config wrangler.containers.jsonc` (hash: 103a39775fb44b96f1ea4718d14ed652)
// Runtime types generated with workerd@1.20260424.1 2026-04-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "OpenCaeFeaContainer";
	}
	interface Env {
		FEA_ARTIFACTS: R2Bucket;
		FEA_RUN_QUEUE: Queue;
		ASSETS: Fetcher;
		FEA_CONTAINER: DurableObjectNamespace<import("./index").OpenCaeFeaContainer>;
	}
}
