/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/opencae-web/worker/worker-configuration.d.ts` (hash: 3f3416612e40ba3ff8e4e780fd2df037)
...
declare namespace Cloudflare {
	...
	interface Env {
		PROJECT_BACKUPS: R2Bucket;
		PROJECT_BACKUP_RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
	}
}
