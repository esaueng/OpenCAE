...
describe("unit display formatting", () => {
  ...
  test("formats result provenance labels with Core FEA and preview separated", () => {
    ...
    expect(formatResultProvenanceLabel({ kind: "opencae_core_fea", solver: "opencae-core-sparse-tet", solverVersion: "0.1.0", meshSource: "actual_volume_mesh", resultSource: "computed", units: "mm-N-s-MPa" })).toBe("OpenCAE Core Local FEA");
    expect(formatResultProvenanceLabel({ kind: "opencae_core_fea", solver: "opencae-core-mdof-tet", solverVersion: "0.1.0", meshSource: "actual_volume_mesh", resultSource: "computed", units: "m-N-s-Pa" })).toBe("OpenCAE Core Local FEA");
