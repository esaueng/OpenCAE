  ...
  function renderTopbar(showRunButton: boolean) {
    ...
    return (
      <header className="topbar">
        ...
        <a className="secondary topbar-action donate-action donate-action-intro" href="https://ko-fi.com/petergn" target="_blank" rel="noreferrer" title="Support OpenCAE on Ko-fi">
